...
clustermarkers_1d <- FindMarkers(Microglia, ident.1 = "1d BBBO",ident.2 = "Sham",slot = "data")
clustermarkers_3d <- FindMarkers(Microglia, ident.1 = "3d BBBO",ident.2 = "Sham",slot = "data")
...
DefaultAssay(Microglia)<-"SCT"
DAMMarkers<-FindMarkers(Microglia,ident.1 = "2",slot = "data")
DAM<-subset(Microglia,idents="2")
Idents(DAM)<-"Treatment"
marks_1d <- FindMarkers(DAM,ident.1 = "1d BBBO",ident.2 = "Sham",only.pos=T,slot="data")
marks_3d <- FindMarkers(DAM,ident.1 = "3d BBBO",ident.2 = "Sham",only.pos=T,slot="data")
...
```{r}
setwd("F:/Data/Sequencing/SavedData")
save(DAMMarkers,DAM_Onto_1d,DAM_Onto_3d,DAMMarkers,Onto_3d,Onto_1d,clustermarkers_AllTreatment,clustermarkers_3d,clustermarkers_1d,Microglia,file="5-MicrogliaFigures.RData")
```
