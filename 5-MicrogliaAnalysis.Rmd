...
clustermarkers <- FindAllMarkers(Microglia, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
markersDAM<-FindMarkers(Microglia,ident.1 = "4")
setwd("F:/Data/Sequencing/SavedData")
...
```{r}
DAM_Onto_1d<-GO_Search(sub2,marks_1d)
...
DAM_Onto_3d<-GO_Search(sub2,marks_3d)
...
clustermarkers <- FindAllMarkers(Microglia, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
setwd("F:/Data/Sequencing/SavedData")
save(DAM_Onto_1d,DAM_Onto_3d,DAM_markers_treatment,DAMMarkers,Onto_3d,Onto_1d,clustermarkers_AllTreatment,clustermarkers_3d,clustermarkers_1d,Microglia,clustermarkers,file="5-MicrogliaFigures.RData")
```
